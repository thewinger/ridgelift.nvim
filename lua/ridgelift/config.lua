...
---@alias Colors table<ridgeliftPalette|ridgeliftPalette|string, string>

---@alias ridgeliftOverrideFn fun(palette: ridgeliftPalette): ridgeliftHighlight
...
---@field colors? ridgeliftPalette
---@field highlights? table<string, ridgeliftHighlight>
---@field overrides? ridgeliftOverrideFn
...
function M.setup(options)
    ...
    vim.g.ridgelift_opts = M.options
end
