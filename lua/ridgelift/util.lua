...
function M.set_options(new_opts)
    local opts = vim.g.ridgelift_opts
    vim.g.ridgelift_opts = vim.tbl_deep_extend("force", opts, new_opts)

    return vim.g.ridgelift_opts
end
...
function M.toggle_lualine_theme()
    ...
    package.loaded["lualine.themes.ridgelift"] = nil
    local lualine_opts = require("lualine").get_config()
    local lualine_theme = require("lualine.themes.ridgelift")
