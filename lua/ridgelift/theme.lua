local colors = require("ridgelift.colors")
...
function M.setup()
    ...
    -- Load base theme
    theme.highlights = require("ridgelift.extensions.base").get(opts, t)

    -- Load enabled extensions
    local extensions = opts.extensions or {}
    for extension, enabled in pairs(extensions) do
        if enabled then
            local ext = require("ridgelift.extensions." .. extension)
